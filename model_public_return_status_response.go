...
// checks if the PublicReturnStatusResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicReturnStatusResponse{}

// PublicReturnStatusResponse struct for PublicReturnStatusResponse
...
type _PublicReturnStatusResponse PublicReturnStatusResponse
...
func NewPublicReturnStatusResponse(createdAt time.Time, items interface{}, returnNumber string, returnOrderId string, status string) *PublicReturnStatusResponse {
	this := PublicReturnStatusResponse{}
...
func (o *PublicReturnStatusResponse) SetNotesNil() {
	o.Notes.Set(nil)
}
...
func (o *PublicReturnStatusResponse) SetOrderNumberNil() {
...
func (o *PublicReturnStatusResponse) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
...
func (o PublicReturnStatusResponse) MarshalJSON() ([]byte, error) {
...
func (o PublicReturnStatusResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PublicReturnStatusResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPublicReturnStatusResponse := _PublicReturnStatusResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPublicReturnStatusResponse)

	if err != nil {
		return err
	}

	*o = PublicReturnStatusResponse(varPublicReturnStatusResponse)

	return err
}

type NullablePublicReturnStatusResponse struct {
	value *PublicReturnStatusResponse
	isSet bool
}

func (v NullablePublicReturnStatusResponse) Get() *PublicReturnStatusResponse {
	return v.value
}

func (v *NullablePublicReturnStatusResponse) Set(val *PublicReturnStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicReturnStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicReturnStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicReturnStatusResponse(val *PublicReturnStatusResponse) *NullablePublicReturnStatusResponse {
	return &NullablePublicReturnStatusResponse{value: val, isSet: true}
}

func (v NullablePublicReturnStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicReturnStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
