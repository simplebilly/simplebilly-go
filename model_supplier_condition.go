...
// checks if the SupplierCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupplierCondition{}

// SupplierCondition struct for SupplierCondition
type SupplierCondition struct {
...
type _SupplierCondition SupplierCondition
...
func (o *SupplierCondition) SetDeliveryTermsNil() {
...
func (o *SupplierCondition) SetEarlyPaymentDiscountPercentNil() {
...
func (o *SupplierCondition) SetMinimumOrderValueNil() {
...
func (o *SupplierCondition) SetNotesNil() {
	o.Notes.Set(nil)
}
...
func (o *SupplierCondition) SetPaymentDueDaysNil() {
...
func (o *SupplierCondition) SetPaymentTermsNil() {
...
func (o *SupplierCondition) SetSupplierNameNil() {
...
func (o SupplierCondition) MarshalJSON() ([]byte, error) {
...
func (o SupplierCondition) ToMap() (map[string]interface{}, error) {
...
func (o *SupplierCondition) UnmarshalJSON(data []byte) (err error) {
	...
	varSupplierCondition := _SupplierCondition{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSupplierCondition)

	if err != nil {
		return err
	}

	*o = SupplierCondition(varSupplierCondition)

	return err
}

type NullableSupplierCondition struct {
	value *SupplierCondition
	isSet bool
}

func (v NullableSupplierCondition) Get() *SupplierCondition {
	return v.value
}

func (v *NullableSupplierCondition) Set(val *SupplierCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableSupplierCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableSupplierCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupplierCondition(val *SupplierCondition) *NullableSupplierCondition {
	return &NullableSupplierCondition{value: val, isSet: true}
}

func (v NullableSupplierCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupplierCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
