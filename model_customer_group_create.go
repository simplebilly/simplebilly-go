...
type _CustomerGroupCreate CustomerGroupCreate
...
func (o *CustomerGroupCreate) SetDescriptionNil() {
...
func (o *CustomerGroupCreate) SetMembershipFilterNil() {
...
func (o *CustomerGroupCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomerGroupCreate := _CustomerGroupCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomerGroupCreate)

	if err != nil {
		return err
	}

	*o = CustomerGroupCreate(varCustomerGroupCreate)
