...
// checks if the ShippingRuleCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingRuleCreate{}

// ShippingRuleCreate struct for ShippingRuleCreate
type ShippingRuleCreate struct {
...
type _ShippingRuleCreate ShippingRuleCreate
...
func (o *ShippingRuleCreate) SetCarrierNil() {
	o.Carrier.Set(nil)
}
...
func (o *ShippingRuleCreate) SetCountryNil() {
	o.Country.Set(nil)
}
...
func (o *ShippingRuleCreate) SetDeliveryTimeNil() {
...
func (o *ShippingRuleCreate) SetMaxWeightKgNil() {
...
func (o *ShippingRuleCreate) SetMinWeightKgNil() {
...
func (o *ShippingRuleCreate) SetNotesNil() {
	o.Notes.Set(nil)
}
...
func (o ShippingRuleCreate) MarshalJSON() ([]byte, error) {
...
func (o ShippingRuleCreate) ToMap() (map[string]interface{}, error) {
...
func (o *ShippingRuleCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varShippingRuleCreate := _ShippingRuleCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varShippingRuleCreate)

	if err != nil {
		return err
	}

	*o = ShippingRuleCreate(varShippingRuleCreate)

	return err
}

type NullableShippingRuleCreate struct {
	value *ShippingRuleCreate
	isSet bool
}

func (v NullableShippingRuleCreate) Get() *ShippingRuleCreate {
	return v.value
}

func (v *NullableShippingRuleCreate) Set(val *ShippingRuleCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingRuleCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingRuleCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingRuleCreate(val *ShippingRuleCreate) *NullableShippingRuleCreate {
	return &NullableShippingRuleCreate{value: val, isSet: true}
}

func (v NullableShippingRuleCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingRuleCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
