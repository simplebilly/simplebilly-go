...
// checks if the ShareholderCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShareholderCreate{}

// ShareholderCreate struct for ShareholderCreate
type ShareholderCreate struct {
...
func (o *ShareholderCreate) SetBirthDateNil() {
	o.BirthDate.Set(nil)
}
...
func (o *ShareholderCreate) SetShareNumberNil() {
...
func (o ShareholderCreate) MarshalJSON() ([]byte, error) {
...
func (o ShareholderCreate) ToMap() (map[string]interface{}, error) {
...
type NullableShareholderCreate struct {
	value *ShareholderCreate
	isSet bool
}

func (v NullableShareholderCreate) Get() *ShareholderCreate {
	return v.value
}

func (v *NullableShareholderCreate) Set(val *ShareholderCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableShareholderCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableShareholderCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShareholderCreate(val *ShareholderCreate) *NullableShareholderCreate {
	return &NullableShareholderCreate{value: val, isSet: true}
}

func (v NullableShareholderCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShareholderCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
