...
// checks if the InventoryCountCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InventoryCountCreate{}

// InventoryCountCreate struct for InventoryCountCreate
...
type _InventoryCountCreate InventoryCountCreate
...
func (o *InventoryCountCreate) SetNotesNil() {
	o.Notes.Set(nil)
}
...
func (o InventoryCountCreate) MarshalJSON() ([]byte, error) {
...
func (o InventoryCountCreate) ToMap() (map[string]interface{}, error) {
...
func (o *InventoryCountCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varInventoryCountCreate := _InventoryCountCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInventoryCountCreate)

	if err != nil {
		return err
	}

	*o = InventoryCountCreate(varInventoryCountCreate)

	return err
}

type NullableInventoryCountCreate struct {
	value *InventoryCountCreate
	isSet bool
}

func (v NullableInventoryCountCreate) Get() *InventoryCountCreate {
	return v.value
}

func (v *NullableInventoryCountCreate) Set(val *InventoryCountCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableInventoryCountCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableInventoryCountCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInventoryCountCreate(val *InventoryCountCreate) *NullableInventoryCountCreate {
	return &NullableInventoryCountCreate{value: val, isSet: true}
}

func (v NullableInventoryCountCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInventoryCountCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
